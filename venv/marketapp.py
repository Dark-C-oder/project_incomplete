...
def existingCustomer():
        ...
        if z == 1:
            ...
            def shopping():
                def popup(s, s1):
                    messagebox.showinfo(s, s1)
                db = dbHelper()
                lt = Label(win1, text="ENTER THE AMOUNT OF SHOPPING CUSTOMER DID", fg="white", bg="black",
            ...
            b = Button(win1, text="Update Customer Details", bg="sky blue", bd=0, width=50, height=2, fg="black",
                       command=updateCustomer).place(x=300, y=120)
            b2 = Button(win1, text="Delete the customer Details", bg="sky blue", bd=0, width=50, height=2, fg="black",
                        command=deleteCustomer).place(x=300, y=180)
            b3 = Button(win1, text="Shopping", bg="sky blue", bd=0, width=50, height=2, fg="black",
                       command= shopping ).place(x=300, y=240)
            exit = Button(win1, text="EXIT", bd=0, bg="black", fg="white", width="30", height=2,
                          command=win1.destroy).place(x=350, y=330)
            c.pack()
    ...
    B2 = Button(win1, text="CONTINUE", bd=0, bg="black", fg="white", width="30", height=2, command=checkActive).place(
        x=350, y=270)
